...
저는 **HRD**에 관심이 많아 교육공학, 원격교육론, 인적자원관리, 평생교육론/평생교육경영론/ 평생교육프로그램개발론 등 관련 수업을 수강하고 있습니다.  프로그램  개발  관련  활동을  실제 로 진행한 경험을 토대로 트라움 주식회사에서 진행하는 **골든튤립 인천에어포트** 교육 운영 프로그램에 동참하여  **HRD**를  더 공부했고,  실무  경험을  쌓았습니다. 낯을  가리지 않아 처음 본 사람과도  쉽게  이야기할  수 있으며  매사에  적극적으로 참여합니다. 언제나 책임감 있는 모습으로 열심히 노력하겠습니다.
...
- 데이터 분석에서 딥러닝까지 핵심적으로 사용되는 파이썬을 기반으로 기초 문법에서 부터 분석
- Python, Git/Github 활용, Markdown, Tableau, 머신러닝을 활용한 데이터 분석, 정렬 알고리즘 및 자료구조 구현



#### 기업교육론 2018. 03 ~ 2018. 07 

- 철도안전전문가 Expert 교육과정 개발
- RFP를 파악하고 소비자의 니즈에 맞춘 교육과정
- Train To Trainers 교육과정
- 교안작성, 인터넷 강의, 온라인 커뮤니티 생성



#### 마케팅리서치 2018. 03 ~ 2018. 07 

- 조사 디자인부터 설분지 개발, SPSS 문항 분석
- 기술통계, 차이검증, 분산분석 등 SPSS를 실습
- 상명대학교 총학생회에 대한 인식조사 : 상명대학교 재학생 196명을 대상으로 개방형, 폐쇄형 질문을 적절히 섞어 설문지를 만들었습니다. 결과의 신뢰성을 높이기 위해 Re-coding을 진행



#### 원격교육론 2017. 03. 02 ~ 2017.07  
